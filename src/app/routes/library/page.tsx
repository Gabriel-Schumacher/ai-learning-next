...
function LibraryPage() {
  ...
  return (
    <div className="p-4">
      ...
      <p className="mb-6">Upload PDF documents to extract and vectorize their content.</p>
      ...
      {pdfText && (
        <div className="mx-auto mt-8 border-t pt-6">
          ...
          <p className="bg-gray-100 p-4 rounded max-h-80 overflow-y-auto">{pdfText.length > 1000 ? `${pdfText.substring(0, 1000)}...` : pdfText}</p>
        </div>
      )}
    </div>
  );
